...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('occwr' in $$props) $$invalidate(9, occwr = $$props.occwr);
		...
		if ('uofkh' in $$props) $$invalidate(14, uofkh = $$props.uofkh);
		if ('bwonf' in $$props) $$invalidate(15, bwonf = $$props.bwonf);
		if ('qoscy' in $$props) $$invalidate(16, qoscy = $$props.qoscy);
	};
